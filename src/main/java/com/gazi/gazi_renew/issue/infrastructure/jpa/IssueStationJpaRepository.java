...
import com.gazi.gazi_renew.issue.infrastructure.IssueStationEntity;
...
public interface IssueStationJpaRepository extends JpaRepository<IssueStationEntity, Long> {
    ...
    @Query("SELECT i FROM IssueStationEntity i JOIN FETCH i.issueEntity WHERE i.issueEntity.id = :issueEntityId")
