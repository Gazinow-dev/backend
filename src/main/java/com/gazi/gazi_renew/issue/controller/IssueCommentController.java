...
public class IssueCommentController extends BaseController {
    ...
    public ResponseEntity<Response.Body> saveComment(@Valid @RequestBody IssueCommentCreate issueCommentCreate) {
        ...
        return response.success(IssueCommentResponse.from(issueComment), "댓글 작성 완료", HttpStatus.CREATED);
    }
    ...
    @GetMapping
    public ResponseEntity<Response.Body> getIssueComments() {
        List<IssueComment> issueComments = issueCommentService.getIssueComments();
        return response.success(IssueCommentResponse.fromList(issueComments), "내가 작성한 댓글 조회 완료", HttpStatus.OK);
    }
    ...
    public ResponseEntity<Response.Body> updateIssueComment(@Valid @RequestBody IssueCommentUpdate issueCommentUpdate) {
        ...
        return response.success(IssueCommentResponse.from(issueComment), "댓글 수정 완료", HttpStatus.OK);
    }
