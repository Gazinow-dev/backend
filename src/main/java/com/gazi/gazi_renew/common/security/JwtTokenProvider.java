...
public class JwtTokenProvider {
    ...
    private static final long ACCESS_TOKEN_EXPIRE_TIME = Duration.ofSeconds(15).toMillis(); // 만료시간 90분
    private static final long REFRESH_TOKEN_EXPIRE_TIME = Duration.ofSeconds(15).toMillis(); // 만료시간 한달(30일)
